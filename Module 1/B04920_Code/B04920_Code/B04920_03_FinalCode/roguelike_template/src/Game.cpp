...
void Game::PopulateLevel()
{
	...
	// Add the gold to our collection of all objects.
...
void Game::Draw(float timeDelta)
{
	...
	case GAME_STATE::PLAYING:
	{
		...
		DrawString(scoreString, sf::Vector2f(m_screenCenter.x - 140.f, 40.f), 40);
		...
		DrawString(goldString, sf::Vector2f(m_screenCenter.x + 260.f, 40.f), 40);
